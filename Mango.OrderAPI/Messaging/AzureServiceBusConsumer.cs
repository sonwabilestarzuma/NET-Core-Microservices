...
using Mango.OrderAPI.MessagesDTOs;
using Mango.OrderAPI.Models;
using Mango.OrderAPI.Repository;
...
namespace Mango.OrderAPI.Messaging
{
    public class AzureServiceBusConsumer : IAzureServiceBusConsumer
    {
        ...
        public AzureServiceBusConsumer(OrderRepository orderRepository, Microsoft.Extensions.Configuration.IConfiguration configuration, IMessageBus messageBus)
        {
